import{_,j as i,o as X,f as m,h as e,a,w as o,l as h,q as b,u,p as f,g as v,t as d,z as g,C as w}from"./index-4soPeDc0.js";/* empty css                     *//* empty css                 *//* empty css                  *//* empty css            */const l=t=>(f("data-v-1fc32c52"),t=t(),v(),t),x={class:"tablePage"},B=l(()=>e("div",{class:"head"},[e("div",{class:"title"},[d(" 表格 "),e("span",null,"TABLE")])],-1)),C={class:"body"},I={class:"card"},E={class:"cardHead"},T={class:"title"},z=l(()=>e("span",null,"基础表格",-1)),D={class:"cardBody"},N=l(()=>e("div",{class:"readme"},[e("p",null,"表格相关注意事项"),e("p",null,"reset已经设置table宽度100%，无需重复设置"),e("p",null,"表格无特殊需求，默认使用带边框的"),e("p",null,"内容超出屏幕宽度左右需要设置fixed给予滚动，不能存在1行字挤成5行的情况"),e("p",null,"虚拟化表格（Virtualized Table）不推荐使用，数据较多时请配合分页组件使用"),e("p",null,[d("API详见"),e("a",{href:"https://element-plus.org/zh-CN/component/table.html"},"表格")])],-1)),V=`
