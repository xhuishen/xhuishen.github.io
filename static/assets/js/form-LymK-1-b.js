import{_ as B,r as h,I as j,j as N,o as P,f as O,h as o,a as e,w as l,l as D,J as M,u as T,t as n,x as z,p as A,g as G,E as H,K as J,L as K,M as L,N as Q,b as W,O as X,P as Y,Q as Z,R as $,S as ee,T as le,A as oe,C as ae}from"./index-5EcmmaJg.js";/* empty css               *//* empty css                 *//* empty css                  *//* empty css            *//* empty css               */const d=m=>(A("data-v-a1784db6"),m=m(),G(),m),te={class:"formPage"},se=d(()=>o("div",{class:"head"},[o("div",{class:"title"},[n(" 表单 "),o("span",null,"FORM")])],-1)),re={class:"body"},de={class:"card"},ie={class:"cardHead"},ne={class:"title"},me=d(()=>o("span",null,"基础表单",-1)),ue={class:"cardBody"},ce=d(()=>o("span",{class:"text-gray-500"},"-",-1)),pe={class:"readme"},be=d(()=>o("p",null,"注意 请使用自带表单验证及重置功能(为了保持样式统一)",-1)),_e=d(()=>o("p",{class:"code"},"ruleFormRef.value.validate((valid) => { })",-1)),fe=d(()=>o("p",{class:"code"},"ruleFormRef.value.resetFields()",-1)),ge=d(()=>o("p",null,"除非个别字段需要重新处理 否者不要使用直接赋值来重置",-1)),ve=d(()=>o("p",{class:"code"},"bad: form.value = { aa:'', bb:'' }",-1)),he=d(()=>o("p",null,[n("API详见"),o("a",{href:"https://element-plus.org/zh-CN/component/form.html"},"FORM表单")],-1)),ye=`
