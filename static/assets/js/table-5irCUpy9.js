import{_ as y,z as r,W as E,v as L,o as p,c as w,a as e,b as a,w as d,X as D,Y as k,E as x,e as B,x as C,Z as I,u as T,q as i,t as u,p as z,g as N,h as S,s as V}from"./index-vJ6HT9sI.js";/* empty css                     *//* empty css                 *//* empty css                *//* empty css            */const m=l=>(z("data-v-978ecd93"),l=l(),N(),l),M={class:"tablePage"},j={class:"body"},P={class:"card"},$={class:"cardHead"},q={class:"title"},A=m(()=>e("span",null,"基础表格",-1)),H={class:"cardBody"},W=m(()=>e("div",{class:"readme"},[e("p",null,"表格相关注意事项"),e("p",null,"reset已经设置table宽度100%，无需重复设置"),e("p",null,"表格无特殊需求，默认使用带边框的，内容居中, 请求数据时需loading状态"),e("p",null,"内容超出屏幕宽度左右需要设置fixed给予滚动，不能存在1行字挤成5行的情况"),e("p",null,"虚拟化表格（Virtualized Table）不推荐使用，数据较多时请配合分页组件使用"),e("p",null,[i(" API详见 "),e("a",{href:"https://element-plus.org/zh-CN/component/table.html"},"表格")])],-1)),Y=`
