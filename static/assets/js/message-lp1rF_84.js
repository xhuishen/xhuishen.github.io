import{_ as w,v as M,o as T,c as N,a as e,b as t,w as o,X as l,Y as i,Z as x,E as I,y as z,u,q as s,p as P,g as S,s as d}from"./index-HU3D_31k.js";const n=a=>(P("data-v-1f9de944"),a=a(),S(),a),W={class:"otherPage"},A={class:"body"},D={class:"card"},H={class:"cardHead"},V={class:"title"},$=n(()=>e("span",null,"主动消息提示",-1)),j={class:"cardBody"},q={class:"readme"},X=n(()=>e("p",null,"此类型提示用于用户操作主动操作后的反馈提示",-1)),Y=n(()=>e("p",null,"接口报错统一用错误提示",-1)),Z=n(()=>e("p",null,[s("API详见"),e("a",{href:"https://element-plus.org/zh-CN/component/message.html"},"消息提示")],-1)),F={class:"card"},G={class:"cardHead"},J={class:"title"},K=n(()=>e("span",null,"被动消息提示",-1)),L={class:"cardBody"},O={class:"readme"},Q=n(()=>e("p",null,"此类型提示用于系统级通知的被动提醒",-1)),R=n(()=>e("p",null,[s("API详见"),e("a",{href:"https://element-plus.org/zh-CN/component/notification.html"},"通知")],-1)),U={class:"card"},ee={class:"cardHead"},te={class:"title"},oe=n(()=>e("span",null,"弹窗",-1)),se={class:"cardBody"},ne={class:"readme"},ce=n(()=>e("p",null,"alert弹窗一般用于强提醒，用户必须知悉的情况",-1)),le=n(()=>e("p",null,"confirm弹窗一般用于提醒用户是否继续等场景",-1)),ae=n(()=>e("p",null,"prompt弹窗一般用于输入一些少量的信息时使用，字段多时建议用modal嵌套form",-1)),ie=n(()=>e("p",null,[s("API详见"),e("a",{href:"https://element-plus.org/zh-CN/component/message-box.html"},"消息弹窗框")],-1)),pe=`
...
} `,ue={__name:"message",setup(a){const m=()=>{l("这是一条普通提示！")},f=()=>{l({message:"这是一条成功提示!",type:"success"})},g=()=>{l({message:"这是一条警告提示！",type:"warning"})},h=()=>{l.error("这是一条错误提示！")},E=()=>{i({title:"Success",message:"成功通知：xxxxxxxxxx",type:"success"})},y=()=>{i({title:"Warning",message:"警告通知：xxxxxxxxx",type:"warning"})},b=()=>{i({title:"Info",message:"一般通知：xxxxxxxxx",type:"info"})},B=()=>{i({title:"Error",message:"错误通知：xxxxxxxxx",type:"error"})},k=()=>{x.alert("alert弹窗","Title",{confirmButtonText:"我知道了"})},v=()=>{x.confirm("confirm弹窗，是否继续?","Warning",{confirmButtonText:"确定",cancelButtonText:"取消",type:"warning"}).then(()=>{l({type:"success",message:"提交成功~"})}).catch(()=>{l({type:"info",message:"取消~"})})},C=()=>{x.prompt("请输入邮箱~","提示",{confirmButtonText:"提交",cancelButtonText:"取消",inputPattern:/[\w!#$%&'*+/=?^_`{|}~-] + (?: \.[\w!#$ %& '*+/=?^_`{|}~-]+)*@(?:[\w](?:[\w-]*[\w])?\.)+[\w](?:[\w-]*[\w])?/,inputErrorMessage:"验证错误"}).then(({value:_})=>{l({type:"success",message:`你的邮箱是:${_}`})}).catch(()=>{l({type:"info",message:"取消输入"})})};return(_,de)=>{const p=I,c=z,r=M("highlightjs");return T(),N("div",W,[e("div",A,[e("div",D,[e("div",H,[e("div",V,[t(p,{color:"#3D4B6C",size:"20"},{default:o(()=>[t(u(d))]),_:1}),$])]),e("div",j,[t(c,{plain:!0,onClick:m},{default:o(()=>[s("消息提示")]),_:1}),t(c,{plain:!0,onClick:f},{default:o(()=>[s("成功提示")]),_:1}),t(c,{plain:!0,onClick:g},{default:o(()=>[s("警告提示")]),_:1}),t(c,{plain:!0,onClick:h},{default:o(()=>[s("错误提示")]),_:1}),e("div",q,[X,Y,Z,t(r,{code:pe})])])]),e("div",F,[e("div",G,[e("div",J,[t(p,{color:"#3D4B6C",size:"20"},{default:o(()=>[t(u(d))]),_:1}),K])]),e("div",L,[t(c,{plain:"",onClick:E},{default:o(()=>[s(" 成功通知 ")]),_:1}),t(c,{plain:"",onClick:y},{default:o(()=>[s(" 警告通知 ")]),_:1}),t(c,{plain:"",onClick:b},{default:o(()=>[s(" 一般通知 ")]),_:1}),t(c,{plain:"",onClick:B},{default:o(()=>[s(" 错误通知 ")]),_:1}),e("div",O,[Q,R,t(r,{code:re})])])]),e("div",U,[e("div",ee,[e("div",te,[t(p,{color:"#3D4B6C",size:"20"},{default:o(()=>[t(u(d))]),_:1}),oe])]),e("div",se,[t(c,{plain:"",onClick:k},{default:o(()=>[s(" alert弹窗 ")]),_:1}),t(c,{plain:"",onClick:v},{default:o(()=>[s(" confirm弹窗 ")]),_:1}),t(c,{plain:"",onClick:C},{default:o(()=>[s(" 提交内容（prompt弹窗） ")]),_:1}),e("div",ne,[ce,le,ae,ie,t(r,{code:xe})])])])])])}}},me=w(ue,[["__scopeId","data-v-1f9de944"]]);export{me as default};
